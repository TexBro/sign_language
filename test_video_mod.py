...
def run_graph( video,labels, input_layer_name, output_layer_name,
              num_top_predictions):
    #testing
...
def main():
  ...
  # load graph, which is stored in the default session
    load_graph(graph)
    video= input("file name with path to play : ")
    
    run_graph(video,label,input_layer,output_layer,num_top_predictions)
